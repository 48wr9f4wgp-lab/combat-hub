...
assert.match(src,/const KNOWN_EVENT_CARD_REFRESH_MS=30\*60\*1000,CARD_POLICY_VERSION=9,LARGE_NEXT_POLICY_VERSION=3/,'known-event refresh cadence/policy version missing');
