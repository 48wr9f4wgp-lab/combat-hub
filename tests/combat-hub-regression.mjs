...
has(/const BOXING_SOURCE_POLICY_VERSION=3/, 'BOXING highlight source policy missing');
...
has(/boxingCandidateMatch/, 'BOXING alias-aware event dedupe missing');
has(/boxingCleanFighterName/, 'BOXING schedule-text fighter cleaner missing');
