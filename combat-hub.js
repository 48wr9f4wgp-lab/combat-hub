...
function supportLabelFor(data,p,index){for(const r of (data?.support||[])){if(sameFight(r.a,r.b,p.a,p.b))return normalizedExistingSupportLabel(r.label,index);}return fallbackSupportLabel(index);}
...
const KNOWN_EVENT_CARD_REFRESH_MS=30*60*1000,CARD_POLICY_VERSION=3;
