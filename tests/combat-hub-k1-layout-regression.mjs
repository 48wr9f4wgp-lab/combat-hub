...
assert.match(src, /const VERSION='7\.7\.4-github'/, 'Expected K-1 polish runtime v7.7.4');
assert.match(src, /k1:\{heroShade:\.60,posterShade:\.46,headerShade:\.10,mainShade:\.11,footShade:\.17,veil:\.055,gap:15,mainSize:13\.6,division:7\.3\}/, 'K-1 main row must move up by 2pt');
