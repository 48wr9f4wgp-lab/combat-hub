...
// v7.23.6-github — parse explicit K-1 overseas JST schedule times; add verified Brasilia fallback; visuals frozen

(async()=>{
const VERSION='7.23.6-github';
