...
assert.match(src,/K-1 WORLD GP 2026 -90KG in BRASILIA/,'verified K-1 Brasilia fallback missing');
assert.match(src,/2026-09-27T07:00:00\+09:00/,'verified K-1 Brasilia JST start missing');
...
assert.ok(src.includes('日本時間\\s*(20\\d{2})年'),'K-1 explicit JST overseas-time parser missing');
assert.match(src,/Brasilia\|BRASILIA\|ブラジリア/,'K-1 Brasilia location normalization missing');
...
assert.match(src,/const BOXING_SOURCE_POLICY_VERSION=3/,'BOXING highlight source policy missing');
